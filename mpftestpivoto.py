...
#table = pd.pivot_table(data=finale2,index=['RMN', 'TrackingNo', 'BatchName', 'OpenBoxBatchLocation', 'BatchStatus'])
##table = pd.pivot_table(data=finale2,index=['RMN', 'TrackingNo', 'BatchName', 'OpenBoxBatchLocation', 'BatchStatus'], columns=['RMN', 'TrackingNo', 'BatchName', 'OpenBoxBatchLocation', 'BatchStatus', 'Paper(DCSID Count)', 'SpecialMedia(DCSID Count)', 'TotalImages(OpenBox)'])
...
#finale4 = pd.DataFrame(table.index.get_level_values(0))
##finale4.columns = ['RMN', 'TrackingNo', 'BatchName', 'OpenBoxBatchLocation', 'BatchStatus', 'TotalImages(OpenBox)']
#finale4
